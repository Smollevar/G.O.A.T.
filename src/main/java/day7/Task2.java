...
class Player {
    ...
    public Player (int stamina) { this.stamina = stamina; if(countPlayers<6)countPlayers++;}
    public int getstamina() { return stamina; }
    public int getcountPlayers() { return countPlayers; }
    private final static int MAX_STAMINA = 100;
    private final static int MIN_STAMINA = 0;
    public void run() {if(stamina==0)return; stamina--;if (stamina == 0)countPlayers--;}
    public static void info () {
        if (countPlayers < 6) {int freeSlot = 6 - countPlayers;
           String GrammarLine = null;
                switch(freeSlot){
                case 1: GrammarLine = "Свободное место"; break;
                case 2: GrammarLine = "Свободных места"; break;
                case 3: GrammarLine = "Свободных места"; break;
                case 4: GrammarLine = "Свободных места"; break;
                case 5: GrammarLine = "Свободных мест"; break;
            }
